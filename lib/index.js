    ...
    inquirer.prompt(questions).then((answers) => {
        ...
        if (!fs.existsSync(projectDir)) {
            ...
            downloadFromUrl(downloadUrl, () => {
                ...
                verboseExec(`mv SETUP/WB-Starter-${ unzippedDirName }/package.json package.json`, verbose);
                log('verbose', `moved package.json`, verbose);

                verboseExec(`mv SETUP/WB-Starter-${ unzippedDirName }/README.md README.md`, verbose);
                log('verbose', `moved package.json`, verbose);
                ...
                verboseExec(`${ answers.npmInstaller } install`, verbose);
